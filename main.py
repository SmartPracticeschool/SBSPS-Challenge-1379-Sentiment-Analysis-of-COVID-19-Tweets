...
class SentimentAnalysis:
    ...
    def DownloadData(self):
        ...
        accessToken = "2481466814-6jFl7rXU1imjHQ38ScsXqY5Yob5OwfdQCrd7e6f"
        accessTokenSecret = "MnrC7DtZ7iEgMOC1PfRyfuGrVPESq6PWkwxTh6yQGvwrX"
        consumerKey = "PiqDWVWstxCGJgzVsK1O9aHyh"
        consumerSecret = "oVZmSyUhvuqQYEc4W5N2jCLe0iudoFf66otY5xbotGdLZVJZmU"
        ...
        # searching for tweets (ye codeblock tweets search karta hai!!)
        ...
        for tweet in self.tweets:
            ...
            # ye wala code sentiments print karega
